(function () {
    ...
    App.prototype.init=function () {
        ...
        self.headingElements();
        self.mobileSideBar();
        self.navBar();
        self.navigation();
        self.oppositeSideBar();
        self.panels();
        self.sideBar();
        self.sidebars();
        self.autoIframe();
    ...
    //Layout
    App.prototype.containerHeight=function () {
    ...
    //
    // ========================================
    App.prototype.headingElements=function () {
    ...
    App.prototype.breadCrumb=function () {
    ...
    App.prototype.sideBar=function () {
        var self=this;

        // Sidebar categories
        $('.category-title [data-action=close]').on("click",function (e) {
            e.preventDefault();
    ...
    App.prototype.sidebars=function () {
        var self=this;
    ...
    App.prototype.oppositeSideBar=function () {
    ...
    App.prototype.autoIframe=function () {
        //iframe
        $(window).on('resize', function() {
