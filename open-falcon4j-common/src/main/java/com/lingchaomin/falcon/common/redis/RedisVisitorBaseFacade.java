...
import com.lingchaomin.falcon.common.redis.constant.LoggerConfigs;
...
public abstract class RedisVisitorBaseFacade implements IRedisCommand {
    ...
    public <T> T lpop(T obj, String key) {
        try {
            return redisManager.lpop(obj, genKey(key));
        } catch (Exception e) {
            LoggerConfigs.REDIS_LOG.error(e.getMessage(), e);
        }
        return null;
    ...
    public <T> T rpop(T obj, String key) {
        try {
            return redisManager.rpop(obj, genKey(key));
        } catch (Exception e) {
            LoggerConfigs.REDIS_LOG.error(e.getMessage(), e);
        }
        return null;
    ...
    public <T> List<T> lrange(T t, String key, long start, long end) {
        try {
            return redisManager.lrange(t, genKey(key), start, end);
        } catch (Exception e) {
            LoggerConfigs.REDIS_LOG.error(e.getMessage(), e);
        }
        return null;
    ...
    public String ltrim(String key, long start, long end) {
        try {
            return redisManager.ltrim(genKey(key), start, end);
        } catch (Exception e) {
            LoggerConfigs.REDIS_LOG.error(e.getMessage(), e);
        }
        return null;
    ...
    public Set<String> keys(String baseKey) {
        try {
            return redisManager.keys(baseKey);
        } catch (Exception e) {
            LoggerConfigs.REDIS_LOG.error(e.getMessage(), e);
        }
        return null;
    ...
    public List<String> brpop(int timeout,String... params) {
        try {
            return redisManager.brpop(timeout,params);
        } catch (Exception e) {
            LoggerConfigs.REDIS_LOG.error(e.getMessage(), e);
        }
        return null;
